...
const bdateSort = inventors.sort((a, b) => a.year > b.year ? 1 : -1)

//Another way
// const bdateSort = inventors.sort(function(a, b){
//     if(a.year > b.year){
//         return 1;
//     }else{
//         return -1;
...
// Another way
// const bdateSort = inventors.sort((a, b) => a.year - b.year)

console.log(bdateSort)



// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const sumAge = inventors.reduce((total, inventor) => {
    return total + (inventor.passed - inventor.year)
}, 0)

//Another way
// const sumAge = inventors.reduce((sum, inventor) => sum + (inventor.passed - inventor.year), 0)
...
//     .map(investor => investor.passed - investor.year)
//     .sort((a, b) => b - a)
